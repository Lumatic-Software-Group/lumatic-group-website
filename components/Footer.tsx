...
export default function Footer() {
  ...
  const services = [
    { label: t.footer.sections.services.links.chatbot, href: "#services" },
    { label: t.footer.sections.services.links.website, href: "#services" },
    { label: t.footer.sections.services.links.aiContent, href: "#services" },
    { label: t.footer.sections.services.links.mobile, href: "#services" },
    { label: t.footer.sections.services.links.aiAgent, href: "#services" },
    { label: t.footer.sections.services.links.growth, href: "#services" },
  ];

  const company = [
    { label: t.footer.sections.company.links.about, href: "#about" },
    { label: t.footer.sections.company.links.work, href: "#portfolio" },
    { label: t.footer.sections.company.links.contact, href: "#contact" },
    { label: t.footer.sections.company.links.portfolio, href: "https://abbasian.dev", external: true },
  ];

  const socials = [
    {
      label: t.footer.socialAriaLabels.linkedin,
      href: "https://www.linkedin.com/in/abbasiandev/",
      icon: (
    ...
    {
      label: t.footer.socialAriaLabels.whatsapp,
    ...
    {
      label: t.footer.socialAriaLabels.telegram,
      ...
      <div className={styles.top}>
        <div className={styles.container}>
          ...
          <div className={styles.col}>
            <h4 className={styles.colTitle}>{t.footer.sections.services.title}</h4>
          ...
          {/* Company col */}
          <div className={styles.col}>
            <h4 className={styles.colTitle}>{t.footer.sections.company.title}</h4>
            <ul className={styles.links}>
              {company.map((c) => (
                <li key={c.label}>
          ...
          {/* Messaging CTA col */}
          <div className={styles.col}>
            <h4 className={styles.colTitle}>{t.footer.sections.startToday.title}</h4>
            <p className={styles.ctaText}>
              {t.footer.sections.startToday.text}
            </p>
            ...
            >
              {activeOption.icon16}
              {t.footer.sections.startToday.cta} {activeOption.label}
            </a>
          </div>
        </div>
      </div>
